<template>
  <div class="content">
    <div class="canvas_wrap" ref="canvas_wrap">
      <canvas
        id="mainForm"
        :style="`transform: translate(-50%,-50%) scale(${(widthOuter - 2) / heightInner})`"
        ref="mainForm"
      ></canvas>
    </div>
    <div class="settings_container">
      <div class="settings">
        <p>Steps remain: {{ steps }}</p>
      </div>
      <div class="controls">
      ...
      <div class="answer">
        <div class="answer_item">
          <button ref="A" :id="Q.A" v-on:click="CheckAnswer(A, Q)">
            <span class="DOT">A</span>{{ Q.A }}
          </button>
        </div>
        <div class="answer_item">
          <button ref="B" :id="Q.B" v-on:click="CheckAnswer(B, Q)">
            <span class="DOT">B</span>{{ Q.B }}
          </button>
        </div>
        <div class="answer_item">
        ...
        <div class="answer_item">
          <button ref="D" :id="Q.D" v-on:click="CheckAnswer(D, Q)" v-if="Q.D">
            <span class="DOT">D</span>{{ Q.D }}
          </button>
        </div>
      </div>
    </div>
    <div class="finished" v-show="hasFinished">
      ...
      <div class="content_wrap row">
        ...
        <div class="right col-12 col-md-24">
          <p>You've been awarded the Medal of<br /><b>green expert!</b></p>
        </div>
      </div>
    </div>
    <footer>
...
//   if(element.correct != element.A && element.correct != element.B && element.correct != element.C && element.correct != element.D){
...
.content {
  ...
  .settings_container {
    ...
    .controls {
      ...
      .move.left::after {
        transform: translate(-50%, -50%) rotate(90deg) translateY(0.07em);
      }

      .move.right::after {
        transform: translate(-50%, -50%) rotate(270deg) translateY(0.07em);
      }
    }
  }
